...
CREATE TABLE customers (
    ...
    contact_title character varying(40),
...
-- CREATE USER sales_northwind WITH PASSWORD 'admin1234';

-- GRANT select ON products TO sales_northwind;
-- GRANT insert ON suppliers TO sales_northwind;
-- GRANT update ON suppliers TO sales_northwind;
